...
#define PLUGIN_NAME_111       "RF Receiver - RC-Switch RX"
        ...
        case PLUGIN_ONCE_A_SECOND:
        {
                ...
                if (rfReceiver->available())
                {
                        ...
                        if (valuerf == 0) {
                                ...
                                UserVar.setFloat(event->TaskIndex, 1, (valuerf & 0xFFFF)) ;//UserVar[event->BaseVarIndex] = (valuerf & 0xFFFF);
                                UserVar.setFloat(event->TaskIndex, 2, (valuerf >> 16) & 0xFFFF); //UserVar[event->BaseVarIndex + 1] = ((valuerf >> 16) & 0xFFFF);
